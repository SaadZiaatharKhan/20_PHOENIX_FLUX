...
const nursesData = [
    { name: 'Bhumi Patil', location: [18.5304109, 73.829973] as [number, number] },
    { name: 'Sheetal Sontakte', location: [18.5304109, 73.829973] as [number, number] },
    { name: 'Anjali Pawaar', location: [18.5304109, 73.829973] as [number, number] },
    { name: 'Mahima Kumar', location: [18.5304109, 73.82997] as [number, number] },
    { name: 'Bharati Gopal', location: [18.5304109, 73.829973] as [number, number] },
    { name: 'Aditi Agarwal', location: [18.5296341, 73.8130026] as [number, number] },
];
